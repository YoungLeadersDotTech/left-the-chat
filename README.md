...
old README backup were excluded. One punctuation character was normalised to
the repository's writing convention. The plugin's manifest and version are
retained from the supplied release.
...
for discovery and trust behaviour.
